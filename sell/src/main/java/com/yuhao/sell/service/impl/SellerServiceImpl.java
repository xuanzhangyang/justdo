...
public class SellerServiceImpl implements SellerService {
    ...
    @Override
    public SellerInfo findByName(String name) {
        return sellerInfoDAO.findByName(name);}

    @Override
    public SellerInfo findByMerchantName(String name) {
        return sellerInfoDAO.findByMerchantName(name);}
