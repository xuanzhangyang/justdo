...
public class OrderMasterServiceImpl implements OrderMasterService{
    ...
    public OrderDTO create(OrderDTO orderDTO) {
        ...
        orderMaster.setIsprint( 0 );
        orderMaster.setIsEnd(0);
        orderMaster.setBuyerDesc(orderDTO.getBuyerDesc() );
...
//    @Override
//    public OrderDTO addDesc(OrderDTO orderDTO) {
//        return null;
//    }
...
//        System.out.println(  );
    ...
    @Override
    public Page<OrderDTO> findList(Pageable pageable, Integer PayStatus, String sellerId) {
        Page<OrderMaster> orderMasterPage=orderMasterDAO.findBySellerIdAndPayStatus(sellerId,PayStatus,pageable);
        List<OrderDTO> orderDTOList = OrderMaster2OrderDTOConverter.convert(orderMasterPage.getContent());
        return new PageImpl<OrderDTO>(orderDTOList, pageable, orderMasterPage.getTotalElements());
    }
    ...
    public List<OrderMaster> findNotIsPrint(String sellerId, Integer isprint) {
        return orderMasterDAO.findBySellerIdAndAndIsprint( sellerId,0 );

    }

//    @Override
//    public List<OrderMaster> findByIsPrint(Integer status) {
//        return orderMasterDAO.findByIsPrint(status);
//    }
    ...
    @Override
    public List<OrderMaster> findAll(Sort sort) {
        return  orderMasterDAO.findAll();
    }
