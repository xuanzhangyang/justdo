...
public interface OrderMasterDAO extends JpaRepository<OrderMaster,String >{
    ...
    public Page<OrderMaster> findBySellerIdAndPayStatus(String sellerId, Integer PayStatus, Pageable pageable);
    /**
     * 通过创建时间和订单状态查找订单
     * @param sellerId
     * @param orderStatus
     ...
     * 打印状态
     */
    public List<OrderMaster> findBySellerIdAndAndIsprint(String sellerId,Integer isprint);
