	...
	<body>
		...
		<#include "../common/nav1.ftl">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="btns">
															...
															<#if productInfo.getProductStatusEnum().message == "在架">
                                                                <a class="delete_Btn" href="/sell/seller/product/off_sale?productId=${productInfo.productId}">售罄</a>
															<#else>
                                                                <a class="delete_Btn" href="/sell/seller/product/on_sale?productId=${productInfo.productId}">有货</a>
															</#if>

                                                            <a class="delete_Btn" onclick="del(${productInfo.productId})">下架</a>
                                                        </td>
                                                    </tr>
													</#list>
			...
			<script>
                function del(id){
                    if(confirm("确认删除吗")){
                        $.getJSON("/sell/seller/product/delete",{productId:id},function(data){
