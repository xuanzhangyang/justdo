                ...
                <div class="col-md-12">
                    <div class="panel peopPan1">
                        ...
                        <div class="panel-body">
                            <form id="" method="post" action="/sell/admin/search">
                                <div class="dataCTop dataQTop clearfix">
                                    <div class="dataCTop2 clearfix"><span class="name">搜索商户</span>
                                        <div class="btn-group">
                                            <input name="search" type="text" class="form-control" placeholder="输入商户名/姓名/手机号">
                                        </div>
                                    </div>
                                    <button class="search_btn"  type="submit">查询</>
                                </div>
                            </form>
                            <div class="pMainWrap clearfix">
                                <div class="tableWrap">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody class="tds">
                                                <#list showInfos as sellerInfo>
                                                <tr >
                                                    <td ><a href="/sell/admin/sellerdetail?phone=${sellerInfo.phone}">${sellerInfo.merchantName}</a></td>
