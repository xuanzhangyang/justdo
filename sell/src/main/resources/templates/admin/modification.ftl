...
<div class="loginsWrap modifysWrap">
    <h1 style="text-align: center; font-size: 50px; color: darkgreen;">修改资料</h1>
    <div class="loginWrap">
        ...
        <div class="loginW modifyWrap">
            ...
            <div class="itemsWrap">
                ...
                <div class="itemWrap">
                    <form id="modification" action="/sell/admin/onModify" method="post">
                        <ul>
                            <li>
                                <div class="item"><input id="oldname" name="oldname" type="text" placeholder="请输入旧用户名"></div>
                            </li>

                            <li>
                                <div class="item"><input id="nname" name="nname" type="text" placeholder="请输入新用户名"></div>
                            </li>
                            <li>
                                <div class="item"><input id="npassword" name="npassword" type="password" placeholder="请输入密码"></div>
                            </li>

                            <li>
                                <div class="item"><input id="phone" name="phone" type="number" placeholder="请输入新手机号"></div>
                            </li>
