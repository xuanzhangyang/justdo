			...
			<div class="loginWrap">
				...
				<div class="loginW modifyWrap">
					...
					<div class="itemsWrap">
						...
						<div class="itemWrap">
							<form id="register" action="/sell/admin/sellerRegister" method="post" enctype="multipart/form-data">
								<ul>
									<li>
                                    ...
                                    <#--<li>-->
                                        <#--<label class="inputName">身份证：</label>-->
                                        <#--<div class="item">-->
                                            <#--<input name="idcard" type="text" placeholder="请输入您的身份证">-->
                                        <#--</div>-->
                                    <#--</li>-->
                                    ...
                                    <li>
                                        <label class="inputName">请上传本人证件照：</label>
                                        <div class="item">
                                            <input id="card" type="file" onchange="imgPreview(this)" name="fileUpload" />
                                        </div>
                                    </li>
                                    ...
                                    <form action="UploadFile.ashx" method="post" >
