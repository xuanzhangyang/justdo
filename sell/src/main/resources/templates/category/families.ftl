												...
												<tbody class="tds">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="btns">
                                                            ...
                                                            <a class="edit_Btn" onclick="del(${category.categoryId},${category.categoryType})">删除</a>
                                                        </td>
                                                    </tr>
													</#list>
        ...
        <div class="modal-dialog">
                    ...
                    <div class="pMainWrap addTeachM clearfix">
                        <form id="add" class="form-horizontal" method="post" action="/sell/seller/category/save">
                            <div class="form-group static"><label for="exampleInputName" class="col-md-3 control-label">名称：</label>
                                <div class="col-md-9">
                                    <input type="text" name="categoryName" class="form-control" id="exampleInputName" placeholder="" value="">
                                </div>
                            </div>
            ...
            <script>
                ...
                function del(id,Type) {
                    if (confirm("确认删除吗")) {
                        $.getJSON("/sell/seller/category/delete", {
                            categoryId: id,
                            categoryType: Type
                        }, function (data) {
                        <#--var map = JSON.parse('${status}')-->
